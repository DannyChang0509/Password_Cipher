...
window = tk.Tk()
window.title('Password_Decryptor')
window.geometry('500x300')

l = tk.Label(window, text = 'Entrypted Password:')
...
tk.Label(window, text = 'Original Password:').place(x = 100, y = 150, anchor = 'n')
...
b = tk.Button(window, text = 'Decrypt', width = 10, height = 1, command = GO)
